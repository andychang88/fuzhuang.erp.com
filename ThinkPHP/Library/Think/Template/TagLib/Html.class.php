...
class Html extends TagLib{
    ...
    protected $tags   =  array(
        ...
        'editor'    => array('attr'=>'id,name,form_name,style,width,height,type','close'=>1),
    	'btn'    => array('attr'=>'id,title,name,style,width,height,type','close'=>0),
    ...
    /**
     * 
	 * <html:btn title="my name" type="reset"/>
    ...
    public function _btn($tag) {
    	...
    	if( $type == 'reset' ){
    		...
    		return "<button type='reset' ".$idstr." class='btn btn-reset '>".$title."</button>";
    		...
    		return "<button type='submit' ".$idstr." class='btn btn-submit btn-primary'>".$title."</button>";
    	}

...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
               <FORM method="get" id="search_frm" onsubmit="return checkSearchfrm();" action="/index.php/Goods/index">
...
<br>      
    ...
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr  class='text-center' >
	        ...
	        <td><a href="/index.php/Goods/add/id/<?php echo ($vo["id"]); ?>">编辑</a> <a  onclick="return confirm('确认要删除吗？');" href="/index.php/Goods/delete/id/<?php echo ($vo["id"]); ?>">删除</a>
	        <br><a href="/index.php/Goods/doAllo/goods_id/<?php echo ($vo["id"]); ?>">分配</a>
	        <a href="/index.php/Goods/alloDetail/goods_id/<?php echo ($vo["id"]); ?>">查看分配</a>
	        </td>
	    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
    
	<?php if(empty($data)): ?><tr><td  colspan=8><div class="viciao">尚无数据</div></td></tr><?php endif; ?>
	
    <tr><td class="pager" colspan=8><div class="viciao"><?php echo ($page); ?></div></td></tr>
    </table>

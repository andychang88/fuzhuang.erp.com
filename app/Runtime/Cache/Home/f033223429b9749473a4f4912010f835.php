...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
               <FORM method="get" id="search_frm" onsubmit="return checkSearchfrm();" action="/index.php/Goods/alloDetail">
...
<br>
    ...
    <tr><td class="pager" colspan=8><div class="viciao"><?php echo ($page_html); ?></div></td></tr>
	
	<?php if(empty($data)): ?><tr><td style="text-align:center;" colspan=8><div class="viciao">尚无数据</div></td></tr><?php endif; ?>

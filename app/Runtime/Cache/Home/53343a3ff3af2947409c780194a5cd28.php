...
<table class='table table-condensed table-hover table-striped tablesorter table-fixed' id='userList'>
    ...
    <?php if(is_array($roles)): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class='text-center'>
	        ...
	        <td>
	        <a href="/index.php/Role/add/id/<?php echo ($vo["id"]); ?>">编辑</a> 
	        <a href="/index.php/Role/priv/role_id/<?php echo ($vo["id"]); ?>">权限</a> 
	        <a onclick="return confirm('确认要删除吗？');" href="/index.php/Role/delete/id/<?php echo ($vo["id"]); ?>">删除</a></td>

...
<table class='table table-condensed table-hover table-striped tablesorter table-fixed' >
   <thead>
    ...
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr  class='text-center' >
	        ...
	        <td><a href="/index.php/Articles/detail/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></td>
			...
			<a href="/index.php/Articles/add/id/<?php echo ($vo["id"]); ?>">编辑</a>  
			<a href="/index.php/Articles/delete/id/<?php echo ($vo["id"]); ?>">删除</a>
    ...
    <tfoot><tr><td class="pager" colspan=6><div class="viciao"><?php echo ($page); ?></div></td></tr></tfoot>
    </table>

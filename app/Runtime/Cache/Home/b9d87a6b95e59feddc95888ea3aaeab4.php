...
<div id="wrap">
  ...
  <div id='titlebar'>
    <div class='heading'>
      <span class='prefix' title='USER'><?php if(empty($vo[id])): ?>新建计划单<?php else: ?>编辑计划单<?php endif; ?></span>
    </div>
  </div>	
  
               <FORM method="post" class="form-condensed"   action="/index.php/Plans/add"  enctype="multipart/form-data" >
               <INPUT type="hidden" name="id" value="<?php echo ($vo["id"]); ?>">
               <table align='center' class='table table-form'>
               
               <tr>
				       <th class="right">Sku：</th> <td><input type="text" name="sku" value="<?php echo ($vo["sku"]); ?>" /></td>
			   </tr>

			    <tr>
				       <th class="right">明细：</th> <td>
					  <table id="tbl2">
							<tr>
							<th>品牌</th>
							<th>语言</th>
			   ...
			   <tr>
				       <th class="right">产品描述：</th> <td><input type="text" name="title" value="<?php echo ($vo["title"]); ?>" /></td>
			   </tr>
			  
			   <tr>
				       <th class="right">预计成本：</th> <td><input type="text" name="total_cost" value="<?php echo ($vo["total_cost"]); ?>" /></td>
			   </tr>
			   <tr>
				       <th class="right">预计出货日期：</th> <td>
				       <input name="produce_time" id="ebayTestStart"  value="<?php echo (format_time($vo["produce_time"])); ?>"  type="text" class="form-date"  />
				       </td>
			   </tr>
			   <tr>
				       <th class="right">产品图片：</th> <td><input type="file" name="photo" /></td>
			   </tr>
			   
			   <tr>
				       <th class="right">备注：</th> <td><textarea name="memo" cols="50" rows="3"><?php echo ($vo["memo"]); ?></textarea></td>
			   </tr>

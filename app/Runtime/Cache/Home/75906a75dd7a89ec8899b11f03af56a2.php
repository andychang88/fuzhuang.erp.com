...
<a href="/index.php/Users/index">用户列表</a> &nbsp;&nbsp;&nbsp;
<a href="/index.php/Users/add">添加用户</a> &nbsp;&nbsp;&nbsp;

<a href="/index.php/Role/index">角色列表</a> &nbsp;&nbsp;&nbsp;
<a href="/index.php/Role/add">添加角色</a> &nbsp;&nbsp;&nbsp;
<a href="/index.php/Role/moduleList">权限列表</a> &nbsp;&nbsp;&nbsp;
<br><br>
...
<style type="text/css">
.group-item{display:block;float:left;width:120px;}
</style>
...
<FORM method="post" id="frm"  action="/index.php/Role/priv">
<input type="hidden" name="role_id" value="<?php echo ($role_id); ?>" />

    <table>
    <tr><th>模块名</th><th>操作</th></tr>

    <?php if(is_array($allModules)): $i = 0; $__LIST__ = $allModules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$module): $mod = ($i % 2 );++$i;?><tr>
	        <td><input type="checkbox" onclick='selectAll(this, "<?php echo ($module["controller_name"]); ?>", "checkbox")' name="allchecker[]" />
	        <?php echo ($module["name"]); ?></td>
	        <td id="<?php echo ($module["controller_name"]); ?>">
	        	<?php if(is_array($module["methodes"])): $i = 0; $__LIST__ = $module["methodes"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$method): $mod = ($i % 2 );++$i;?><span class="group-item"><input type="checkbox" <?php if($method["selected"] == 1): ?>checked<?php endif; ?> onclick='selectAll(this, "index", "checkbox")' name="methodes[<?php echo ($module["controller_name"]); ?>][]" value='<?php echo ($method["id"]); ?>' />
	        		<?php echo ($method["name"]); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
	        </td>
